...
const BACKGROUND_VERSIONS = [
  ...
  '0446c49abe7c28823bbd199a73801acff16520ea',
  '8e09df228690d4971861a7b18d1b10a88199e12e',
]

const assetUrl = (name, version) => {
  const url = new URL(`./assets/atelier/${name}`, import.meta.url)
...
const applyBackground = () => {
  ...
  try {
    ...
    // Ignore storage failures; the visual switch still works for this session.
  }
}
